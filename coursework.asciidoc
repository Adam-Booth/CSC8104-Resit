...
A Discussion Boards will also be available for CSC8104 in Canvas (http://canvas.ncl.ac.uk) and Teams. You may post any questions about the tutorial or coursework assignment here. Any questions encountered frequently will be placed in a *Frequently Asked Questions* document which we maintain https://github.com/NewcastleComputingScience/enterprise-middleware-coursework/blob/master/frequentlyaskedquestions.asciidoc[here]. Before asking a question we encourage you to check this link to see if it has already been answered.

The use of 3rd party documentation is absolutely *essential* throughout this coursework, and we may often answer questions by pointing you to the relevant websites.
